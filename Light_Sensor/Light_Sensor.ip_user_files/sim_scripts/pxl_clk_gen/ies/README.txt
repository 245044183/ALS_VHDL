...
#
# Generated by export_simulation on Sun Dec 01 17:31:44 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './pxl_clk_gen.sh' script.

./pxl_clk_gen.sh -reset_run
...
./pxl_clk_gen.sh -noclean_files

For more information on the script, please type './pxl_clk_gen.sh -help'.
